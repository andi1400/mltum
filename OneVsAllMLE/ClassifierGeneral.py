...
PARAMETERS = {'MLE': [6e-5, 0.991], 'SOFTZEROONE': [0.0001, 0.99993, 2.5, 1e-7], 'HINGE': [8e-5, 0.9995], 'MAV': None, 'WAVG': None, 'NN': [1e-2, 1, 5, [16, 100, 100, 100, 5]], 'NND': [1e-3, 1, 4, [16, 1000, 1000, 5]]}
